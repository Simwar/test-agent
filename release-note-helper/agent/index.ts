...
1. Default Jira project key (e.g. "FLOWS")
2. GitHub owner and repo for PR lookups (e.g. "postmanlabs/flows")
...
like "all Flows issues moved to done in the past week" or "PLATFORM project, last
2 weeks."
